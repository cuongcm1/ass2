...
if(isset($_POST['submit'])){
	...
	if(isset($ten_sp) && isset($gia_sp) && isset($bao_hanh) && isset($phu_kien) && isset($tinh_trang) && isset($khuyen_mai) && isset($trang_thai) && isset($chi_tiet_sp) && isset($anh_sp) && isset($id_dm) && isset($dac_biet)){
		...
		$sql = "INSERT INTO sanpham(ten_sp, gia_sp, bao_hanh, phu_kien, tinh_trang, khuyen_mai, trang_thai, chi_tiet_sp, anh_sp, id_dm, dac_biet) 
...
<div id="main">
    ...
    <table id="add-prd" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td><label>Ảnh mô tả</label><br /><input type="file" name="anh_sp" /> <?php if(isset($error_anh_sp)){echo $error_anh_sp;}?></td></td>
        </tr>
        <tr>
            <td><label>Nhà cung cấp</label><br />
                ...
                </select> <?php if(isset($error_id_dm)){echo $error_id_dm;}?></td>	
            </td>
        </tr>
        <tr>
